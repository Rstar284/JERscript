...
var grammar = {
    ...
    {"name": "array$ebnf$1$subexpression$1", "symbols": ["expr", "_"]},
    {"name": "array$ebnf$1", "symbols": ["array$ebnf$1", "array$ebnf$1$subexpression$1"], "postprocess": function arrpush(d) {return d[0].concat([d[1]]);}},
    {"name": "array", "symbols": [(myLexer.has("lbracket") ? {type: "lbracket"} : lbracket), "_", "array$ebnf$1", (myLexer.has("rbracket") ? {type: "rbracket"} : rbracket)], "postprocess": 
        (data) => {
            return {
                type: "array",
